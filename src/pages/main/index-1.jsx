...
const Main = () => {
  ...
  const renderer = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
      return (
        <div className="flex flex-row items-center justify-between mt-24 gap-9">
      ...
      return (
        <div className="flex flex-row items-center justify-between mt-52 gap-9">
          <div className="flex flex-col items-center justify-center gap-2">
            <div className="p-2 text-base text-white border-b-2 roboto-bold border-soft-white">
              {days}
            </div>
  ...
  return (
    <>
      <div className="w-full h-full">
        {/* section event */}
        <div
          className={`${style.event} default-bg container max-w-screen-sm h-full flex flex-col justify-center items-center`}
        >
          <span className="text-sm font-light text-white mt-80 roboto-light">
            The Wedding of
          </span>
          <span className="mt-5 text-5xl font-light text-white great-vibes-regular">
            Qisti & Elgi
          </span>
          <span className="mt-6 text-sm font-light text-white roboto-light">
            14.07.2024
          </span>
          <Countdown date={targetDate} renderer={renderer} />
          <span
            className="px-10 mt-8 mb-16 text-sm text-justify text-white text-pretty roboto-regular"
            data-aos="fade-up"
      ...
      {/* section about */}
      <div
        className={`${style.about} default-bg container max-w-screen-sm h-full flex flex-col justify-center items-center`}
      >
        {/* section man */}
        <div className="flex flex-col items-start w-full px-10">
          ...
          <Link
            ...
            data-aos-duration="3000"
          >
            <img src={icInstagram} className="object-cover h-5" />
        ...
        <div className="flex flex-col items-end w-full px-10 mt-12 mb-12">
          <img src={womanPhoto} data-aos="zoom-out" data-aos-duration="3000" />
          <span
            className="mt-5 text-xl text-white roboto-medium"
            data-aos="fade-up"
            data-aos-duration="3000"
          ...
          <span
            ...
            data-aos-duration="3000"
          >
            The child of Mr.Ir. Agus Jindar Mukhfid and Mrs. Siti Suwarni, S.E ,
            born in Bandung on June 22, 1995
          </span>
          <Link
      ...
      <div
        className={`${style.journey} default-bg container max-w-screen-sm h-full flex flex-col px-10`}
      >
        <span
          className="mt-12 text-4xl leading-tight text-white roboto-light"
          data-aos="fade-up"
          data-aos-duration="3000"
        >
        ...
        <span
          ...
          data-aos-duration="3000"
        >
          A love journey ideally continues to evolve over time, with the couple
          navigating lifes ups and downs together. Maintaining love and passion
          requires ongoing effort, communication, and a commitment to each
          others happiness and well-being. Celebrating milestones, cherishing
          memories, and facing challenges as a team are essential aspects of a
          lasting love journey.
        </span>
        <span
        ...
        <span
          ...
          data-aos-duration="3000"
        >
          Jl. Raya Cinunuk No.186, Cinunuk, Kec. Cileunyi, Kabupaten Bandung,
          Jawa Barat 40624
        </span>
        <Link
          ...
          data-aos-duration="3000"
        >
          <img src={icMaps} className="object-cover h-5" />
          <span className="text-sm text-white roboto-medium">Direct Me</span>
        </Link>
      </div>

      {/* section dresscode */}
      <div
        className={`${style.dresscode} default-bg container max-w-screen-sm h-full flex flex-col px-10`}
      >
        <span
        ...
        <span
          ...
          data-aos-duration="3000"
        >
          Loving and caring have become the vows we pledge to uphold throughout
          our lives. Thank you for witnessing our commitment and the prayers
          you’ve bestowed on our joyful day
        </span>
        <form
        ...
        {dataMessage.length > 0 && (
          <>
            <span
              className="mt-2 text-2xl text-white roboto-light"
              data-aos="fade-up"
              data-aos-duration="3000"
            >
            ...
            <div
              className="mt-4 mb-5 overflow-scroll max-h-[300px] flex gap-4 flex-col"
              data-aos="fade-up"
              data-aos-duration="3000"
            >
                ...
                >
                  <span className="text-sm border-b-[1px] pb-2 mb-2 text-dark-green border-dark-green roboto-medium">
                    ...
                    <span className="roboto-light">
                      {item.attendance === 1 ? "I'm Come" : "Sorry, I cannot"}
                    </span>
                  </span>
      ...
      <div
        className={`${style.weddingGift} default-bg container max-w-screen-sm h-screen flex flex-col justify-center px-10`}
      >
        ...
        <span
          ...
          data-aos-duration="3000"
        >
          Even we cannot express in words how fortunate we are to have someone
          so wise and kind-hearted in our lives!
        </span>
        <div className="flex flex-row items-center mt-10 gap-7">
          ...
          >
            <div className="flex flex-row items-center gap-3">
              ...
              >
                <img src={icCopy} className="object-cover h-3" />
              </button>
            </div>
      ...
      <div
        className={`${style.weddingGift} default-bg container max-w-screen-sm h-full flex flex-col px-10`}
      >
        <span
          className="mt-12 text-4xl text-white roboto-light"
          data-aos="fade-up"
      ...
      {/* section footer */}
      <div
        className={`${style.footer} default-bg container max-w-screen-sm flex flex-col px-10 h-full`}
      >
        <img
          src={footerPhoto}
        ...
        <span
          ...
          data-aos-duration="3000"
        >
          It is an honor and joy for us if you would kindly attend to give your
